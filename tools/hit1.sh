...
for((x=1;x<=19;x++));
  do  
    cat ${1}  | grep + | grep  -P "chr${x}\t" | awk '{print $5}' | sort -g | uniq -c | sort -g -k+1 > chr${x}+.hits.txt &       
  done
    wait
    cat ${1}  | grep + | grep  -P "chrX\t" | awk '{print $5}' | sort -g | uniq -c | sort -g -k+1 > chrX+.hits.txt        
    cat ${1}  | grep + | grep  -P "chrY\t" | awk '{print $5}' | sort -g | uniq -c | sort -g -k+1 > chrY+.hits.txt        
...
then
    ...
    cat ${1}  | grep + | grep  -P "chrI\t" | awk '{print $5}' | sort -g | uniq -c | sort -g -k+1 > chr1+.hits.txt        
    cat ${1}  | grep + | grep  -P "chrII\t" | awk '{print $5}' | sort -g | uniq -c | sort -g -k+1 > chr2+.hits.txt  
    cat ${1}  | grep + | grep  -P "chrIII\t" | awk '{print $5}' | sort -g | uniq -c | sort -g -k+1 > chr3+.hits.txt        
    cat ${1}  | grep + | grep  -P "chrIV\t" | awk '{print $5}' | sort -g | uniq -c | sort -g -k+1 > chr4+.hits.txt
    cat ${1}  | grep + | grep  -P "chrV\t" | awk '{print $5}' | sort -g | uniq -c | sort -g -k+1 > chr5+.hits.txt        
    cat ${1}  | grep + | grep  -P "chrVI\t" | awk '{print $5}' | sort -g | uniq -c | sort -g -k+1 > chr6+.hits.txt        
    cat ${1}  | grep + | grep  -P "chrVII\t" | awk '{print $5}' | sort -g | uniq -c | sort -g -k+1 > chr7+.hits.txt        
    cat ${1}  | grep + | grep  -P "chrVIII\t" | awk '{print $5}' | sort -g | uniq -c | sort -g -k+1 > chr8+.hits.txt        
    cat ${1}  | grep + | grep  -P "chrIX\t" | awk '{print $5}' | sort -g | uniq -c | sort -g -k+1 > chr9+.hits.txt        
    cat ${1}  | grep + | grep  -P "chrX\t" | awk '{print $5}' | sort -g | uniq -c | sort -g -k+1 > chr10+.hits.txt        
    cat ${1}  | grep + | grep  -P "chrXI\t" | awk '{print $5}' | sort -g | uniq -c | sort -g -k+1 > chr11+.hits.txt        
    cat ${1}  | grep + | grep  -P "chrXII\t" | awk '{print $5}' | sort -g | uniq -c | sort -g -k+1 > chr12+.hits.txt        
    cat ${1}  | grep + | grep  -P "chrXIII\t" | awk '{print $5}' | sort -g | uniq -c | sort -g -k+1 > chr13+.hits.txt        
    cat ${1}  | grep + | grep  -P "chrXIV\t" | awk '{print $5}' | sort -g | uniq -c | sort -g -k+1 > chr14+.hits.txt        
    cat ${1}  | grep + | grep  -P "chrXV\t" | awk '{print $5}' | sort -g | uniq -c | sort -g -k+1 > chr15+.hits.txt        
    cat ${1}  | grep + | grep  -P "chrXVI\t" | awk '{print $5}' | sort -g | uniq -c | sort -g -k+1 > chr16+.hits.txt
    cat ${1}  | grep + | grep  -P "chrM\t" | awk '{print $5}' | sort -g | uniq -c | sort -g -k+1 > chrM+.hits.txt                
